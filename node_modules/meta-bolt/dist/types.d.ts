...
export interface ArgTemplateGeneric {
    name: string;
    type: "folder" | "string" | "boolean" | "select" | "multiselect" | "confirm" | "text";
    message: string;
    initialValue?: string | boolean;
    required: boolean;
    validator?: ((input: string) => void | string) | ((input: string[]) => void | string);
    describe: string;
    options?: ArgOpt[];
    alias?: string;
}
...
export type ArgTemplateTypes = ArgTemplateBoolean | ArgTemplateString | ArgTemplateSelect;
