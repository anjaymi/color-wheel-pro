...
export const id = "com.bolt.uxpcom.psplus.colorwheel3"; 
const name = "喵色环";
...
const manifest: UXP_Manifest = {
  ...
  entrypoints: [
    {
      ...
      minimumSize: { width: 280, height: 480 },
      maximumSize: { width: 280, height: 1200 },
      preferredDockedSize: { width: 280, height: 600 },
      preferredFloatingSize: { width: 280, height: 600 },
      icons: [
        {
          width: 23,
          height: 23,
  ...
  requiredPermissions: {
    ...
    enableAddon: true, // POTENTIALLY LATER
  },
  // BOLT_HYBRID_START
  addon: {
